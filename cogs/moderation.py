...
class Moderation(commands.Cog):
                    ...
                    if guild.me.guild_permissions.ban_members:
                        async for entry in guild.bans():
                            if entry.user.id == user_id:
                                await guild.unban(entry.user, reason="Timezones Moderation: Temporary ban has been lifted")
                                await self.bot.db.execute(
                                ...
                                if jail_role := guild.get_role(jail_role_id):
                                    if jail_role in member.roles:
                                        await member.remove_roles(
                                            jail_role,
                                            reason="Timezones Moderation: Jail has been lifted"
                                        )
                                        ...
                                        await member.add_roles(
                                            *(guild.get_role(role_id) for role_id in taken_roles if guild.get_role(role_id) and guild.get_role(role_id).is_assignable()),
                                            reason="Timezones Moderation: Restoring roles taken due to jail",
                                            atomic=False
                                        )
                            ...
                            if mute_role_id := await self.bot.db.fetchval("SELECT mute_role_id FROM guild_settings WHERE guild_id = %s;", guild_id):
                                if mute_role := guild.get_role(mute_role_id):
                                    if mute_role in member.roles:
                                        await member.remove_roles(
                                            mute_role,
                                            reason="Timezones Moderation: Mute has been lifted"
                                        )
                                        taken_roles = await self.bot.db.fetch(
                                            "SELECT role_id FROM taken_roles WHERE guild_id = %s AND user_id = %s;",
                                            guild_id, user_id
                                        ...
                                        await member.add_roles(
                                            *(guild.get_role(role_id) for role_id in taken_roles if guild.get_role(role_id) and guild.get_role(role_id).is_assignable()),
                                            reason="Timezones Moderation: Restoring roles taken due to mute",
                                            atomic=False
                                        )
    ...
    async def on_audit_log_entry_create(self, entry: discord.AuditLogEntry):
        ...
        if _user := re.findall(r"Timezones Moderation \[(.+)\]", reason or ""):
        ...
        if action == discord.AuditLogAction.unban:
            ...
            if target.id in await self.bot.db.fetch("SELECT user_id FROM hard_banned WHERE guild_id = %s;", guild.id):
                await guild.ban(
                    target,
                    reason="Timezones Moderation: User is hard banned"
                )
    ...
    async def tempban(
        ...
        *, 
        ...
        reason = core.strip_flags(reason, ctx)
        if not reason:
        ...
        await ctx.guild.ban(
            ...
            reason=f"Timezones Moderation [{ctx.author}]: {reason}"
        )
        await self.bot.db.execute(
        ...
        return await ctx.success(f"Successfully **banned** {member.mention} temporarily for `{core.fmtseconds(timespan.seconds)}`.")
    ...
    @commands.has_permissions(manage_messages=True)
    async def cleanup(self, ctx: core.Context, amount: int = 100):
    ...
    async def thread(self, ctx: core.Context):
    ...
    @commands.bot_has_permissions(manage_threads=True)
    @commands.has_permissions(manage_threads=True)
    async def thread_lock(self, ctx: core.Context, thread: Optional[discord.Thread] = None, *, reason: str = "No reason provided"):
        """Lock a thread"""
    ...
    @commands.bot_has_permissions(manage_threads=True)
    @commands.has_permissions(manage_threads=True)
    async def thread_unlock(self, ctx: core.Context, thread: Optional[discord.Thread] = None, *, reason: str = "No reason provided"):
        """Unlock a thread"""
    ...
    @commands.bot_has_permissions(manage_threads=True)
    @commands.has_permissions(manage_threads=True)
    async def thread_archive(self, ctx: core.Context, thread: Optional[discord.Thread] = None, *, reason: str = "No reason provided"):
        """Archive a thread"""
    ...
    @commands.bot_has_permissions(manage_threads=True)
    @commands.has_permissions(manage_threads=True)
    async def thread_unarchive(self, ctx: core.Context, thread: Optional[discord.Thread] = None, *, reason: str = "No reason provided"):
        """Unarchive a thread"""
    ...
    @commands.bot_has_permissions(manage_threads=True)
    @commands.has_permissions(manage_threads=True)
    async def thread_pin(self, ctx: core.Context, thread: Optional[discord.Thread] = None):
        """Pin a thread"""
    ...
    @commands.bot_has_permissions(manage_threads=True)
    @commands.has_permissions(manage_threads=True)
    async def thread_unpin(self, ctx: core.Context, thread: Optional[discord.Thread] = None):
        """Unpin a thread"""
    ...
    async def lockdown(self, ctx: core.Context, channel: Optional[discord.TextChannel] = None, *, reason: str = "No reason provided"):
        """Lockdown a channel"""
    ...
    @commands.bot_has_permissions(manage_channels=True)
    @commands.has_permissions(manage_channels=True)
    async def lockdown_all(self, ctx: core.Context, *, reason: str = "No reason provided"):
        """Lock every channel"""
    ...
    @commands.bot_has_permissions(manage_channels=True)
    @commands.has_permissions(manage_channels=True)
    async def lockdown_remove(self, ctx: core.Context, channel: Optional[discord.TextChannel] = None, *, reason: str = "No reason provided"):
        """Unlock a channel"""
    ...
    @commands.bot_has_permissions(manage_channels=True)
    @commands.has_permissions(manage_channels=True)
    async def lockdown_remove_all(self, ctx: core.Context, *, reason: str = "No reason provided"):
    ...
    @commands.bot_has_permissions(manage_channels=True)
    @commands.has_permissions(manage_channels=True)
    async def unlock(self, ctx: core.Context, channel: Optional[discord.TextChannel] = None, *, reason: str = "No reason provided"):
        """Unlock a channel"""
    ...
    @commands.bot_has_permissions(manage_channels=True)
    @commands.has_permissions(manage_channels=True)
    async def unlock_all(self, ctx: core.Context, *, reason: str = "No reason provided"):
        """Unlock every channel"""
    ...
    @commands.bot_has_permissions(manage_channels=True)
    @commands.has_permissions(manage_channels=True)
    async def moveall(self, ctx: core.Context, channel: discord.VoiceChannel, *, reason: str = "No reason provided"):
    ...
    async def stripstaff(self, ctx: core.Context, *, member: core.MemberConverter):
        ...
        await member.remove_roles(
            *(role for role in member.roles if role.is_assignable() and list(filter(lambda p: p[1], (role.permissions & discord.Permissions.elevated())))),
            reason=f"Timezones Moderation [{ctx.author}]: Stripped staff roles from member",
            atomic=False
        )
    ...
    @commands.has_permissions(manage_roles=True)
    async def setup(self, ctx: core.Context):
        ...
        if ctx.guild.get_role(mute_role_id) is None:
            mute_role = discord.utils.get(ctx.guild.roles, name="Muted") or await ctx.guild.create_role(
                name="Muted",
                reason=f"Timezones Moderation [{ctx.author}]: Setting up moderation system"
            )
            mute_role_id = mute_role.id
        
        if ctx.guild.get_role(jail_role_id) is None:
            jail_role = discord.utils.get(ctx.guild.roles, name="Jailed") or await ctx.guild.create_role(
                name="Jailed",
                reason=f"Timezones Moderation [{ctx.author}]: Setting up moderation system"
            )
    ...
    @commands.bot_has_permissions(administrator=True)
    @commands.has_permissions(manage_messages=True)
    async def jail(self, ctx: core.Context, member: core.MemberConverter, timespan: Optional[core.Timespan] = None, *, reason: str = "No reason provided"):
        ...
        await member.remove_roles(
            *(role for role in roles if role.is_assignable()),
            reason=f"Timezones Moderation [{ctx.author}]: Member jailed",
            atomic=False
        )
        await asyncio.gather(*(
    ...
    @commands.bot_has_permissions(administrator=True)
    @commands.has_permissions(manage_messages=True)
    async def unjail(self, ctx: core.Context, member: core.MemberConverter):
        ...
        if jail_role := ctx.guild.get_role(jail_role_id):
            if jail_role in member.roles:
                await member.remove_roles(
                    jail_role,
                    reason="Timezones Moderation: Member has been unjailed"
                )
    ...
    @commands.has_permissions(manage_messages=True)
    async def jailed(self, ctx: core.Context):
    ...
    @commands.has_permissions(manage_messages=True)
    async def moderationhistory(self, ctx: core.Context, member: Optional[core.MemberConverter] = commands.Author):
    ...
    @commands.has_permissions(manage_messages=True)
    async def history(self, ctx: core.Context, member: Optional[core.MemberConverter] = commands.Author):
    ...
    @commands.has_permissions(manage_messages=True)
    async def history_remove(self, ctx: core.Context, member: core.MemberConverter, case_id: int):
    ...
    @commands.has_permissions(manage_messages=True)
    async def history_remove_all(self, ctx: core.Context, member: core.MemberConverter):
    ...
    @commands.has_permissions(manage_messages=True)
    async def reason(self, ctx: core.Context, case_id: Optional[int] = None, *, reason: str):
    ...
    async def timeout(
        ...
        ctx: core.Context, 
        member: core.MemberConverter,
        timespan: Optional[core.Timespan] = None,
        *,
        reason: str = "No reason provided"
    ):
        ...
        return await ctx.success(f"Successfully **timed out** {member.mention} for `{core.fmtseconds(timespan.seconds if timespan else 3600)}`.")
    ...
    @commands.bot_has_permissions(moderate_members=True)
    @commands.has_permissions(moderate_members=True)
    async def untimeout(self, ctx: core.Context, member: core.MemberConverter):
        ...
        await member.timeout(
            None,
            reason=f"Timezones Moderation [{ctx.author}]"
        )
    ...
    @commands.bot_has_permissions(moderate_members=True)
    @commands.has_permissions(moderate_members=True)
    async def untimeout_all(self, ctx: core.Context):
    ...
    @commands.command(
        ...
        aliases=("m",),
        usage="<member> [time d/h/m/s] [reason]",
        example="@mikk.a 10m Breaking the rules",
        parameters={
            "silent": {
                "require_value": False,
                "description": "Don't DM the member",
    ...
    async def mute(
        ...
        *, 
        ...
        await member.remove_roles(
            *(role for role in roles if role.is_assignable()),
            reason=f"Timezones Moderation [{ctx.author}]: Member muted",
            atomic=False
        )
        await asyncio.gather(*(
            self.bot.db.execute("INSERT INTO taken_roles (guild_id, user_id, role_id) VALUES (%s, %s, %s);", ctx.guild.id, member.id, role.id)
        ...
        return await ctx.success(f"Successfully **muted** {member.mention} for `{core.fmtseconds(timespan.seconds if timespan else 2419200)}`.")
    ...
    @commands.bot_has_permissions(administrator=True)
    @commands.has_permissions(manage_messages=True)
    async def unmute(self, ctx: core.Context, member: core.MemberConverter):
        ...
        if mute_role := ctx.guild.get_role(mute_role_id):
            if mute_role in member.roles:
                await member.remove_roles(
                    mute_role,
                    reason="Timezones Moderation: Member has been unmuted"
                )
    ...
    @commands.bot_has_permissions(moderate_members=True)
    @commands.has_permissions(moderate_members=True)
    async def unmute_all(self, ctx: core.Context):
    ...
    @commands.has_permissions(manage_messages=True)
    async def muted(self, ctx: core.Context):
    ...
    @commands.has_permissions(manage_messages=True)
    async def timedout(self, ctx: core.Context):
    ...
    @commands.bot_has_permissions(manage_channels=True)
    @commands.has_permissions(manage_messages=True)
    async def iunmute(self, ctx: core.Context, member: core.MemberConverter):
    ...
    @commands.command(
        ...
        usage="<member> [reason]",
        example="@mikk.a Breaking the rules",
        parameters={
            "silent": {
                "require_value": False,
                "description": "Don't DM the member",
    ...
    @commands.bot_has_permissions(manage_channels=True)
    @commands.has_permissions(manage_messages=True)
    async def runmute(self, ctx: core.Context, member: core.MemberConverter):
    ...
    async def notes(
        ...
        ctx: core.Context, 
        *, 
        member: Optional[core.MemberConverter] = commands.Author
    ):
    ...
    @commands.has_permissions(manage_messages=True)
    async def notes_clear(self, ctx: core.Context, member: core.MemberConverter):
    ...
    @commands.bot_has_permissions(ban_members=True)
    @commands.has_permissions(administrator=True)
    async def hardunban(self, ctx: core.Context, user: core.UserConverter):
        """Revoke the mentioned user's hard ban"""
            
        await ctx.guild.unban(
            user,
            reason=f"Timezones Moderation [{ctx.author}]: Hard ban has been revoked"
        )
        await self.bot.db.execute(
    ...
    @commands.has_permissions(manage_messages=True)
    async def hardbanned(self, ctx: core.Context):
    ...
    async def clearinvites(self, ctx: core.Context):
    ...
    @commands.command(
        ...
        example="@cop#0001 @mikk.a #Main Voice"
    )
    @commands.bot_has_permissions(manage_channels=True)
    ...
    async def drag(
        self,
        ctx: core.Context,
        members: commands.Greedy[core.MemberConverter],
        *,
    ...
    @commands.bot_has_permissions(ban_members=True)
    @commands.has_permissions(administrator=True)
    async def unbanall(self, ctx: core.Context):
        ...
        async for ban in ctx.guild.bans(limit=1000):
            ...
            await ctx.guild.unban(
                ban.user,
                reason="Timezones Moderation [{ctx.author}]: Unbanning all users"
            )
            unbanned += 1
    ...
    @commands.has_permissions(administrator=True)
    async def unbanall_cancel(self, ctx: core.Context):
    ...
    async def ban(
        self, 
        ctx: core.Context, 
        user: Union[core.UserConverter, core.MemberConverter],
    ...
    @commands.bot_has_permissions(ban_members=True)
    @commands.has_permissions(ban_members=True)
    async def unban(self, ctx: core.Context, user: core.UserConverter):
    ...
    async def softban(
        ...
        *, 
        ...
        await ctx.guild.unban(
            member,
            reason=f"Timezones Moderation [{ctx.author}]: User was soft banned"
        )
    ...
    @commands.bot_has_permissions(ban_members=True)
    @commands.has_permissions(ban_members=True)
    async def banned(self, ctx: core.Context, *, user: core.UserConverter):
    ...
    @commands.group(
        ...
        aliases=("r",),
        usage="<member> <roles>",
        example="@mikk.a @Staff @Moderator",
        invoke_without_command=True
    )
    @commands.bot_has_permissions(manage_roles=True)
    @commands.has_permissions(manage_roles=True)
    async def role(self, ctx: core.Context, member: core.MemberConverter, *roles: core.RoleConverter):
    ...
    @commands.bot_has_permissions(manage_roles=True)
    @commands.has_permissions(administrator=True)
    async def role_add(self, ctx: core.Context):
    ...
    @commands.bot_has_permissions(manage_roles=True)
    @commands.has_permissions(administrator=True)
    async def role_add_bots(self, ctx: core.Context, *, role: core.RoleConverter):
        ...
        for member in members:
            ...
            try:
                await member.add_roles(
                    role,
                    reason=f"Timezones Moderation [{ctx.author}]: Mass role (bots)"
                )
    ...
    @commands.bot_has_permissions(manage_roles=True)
    @commands.has_permissions(administrator=True)
    async def role_add_humans(self, ctx: core.Context, *, role: core.RoleConverter):
        ...
        for member in ctx.guild.members:
            ...
            try:
                await member.add_roles(
                    role,
                    reason=f"Timezones Moderation [{ctx.author}]: Mass role (humans)"
                )
    ...
    @commands.bot_has_permissions(manage_roles=True)
    @commands.has_permissions(administrator=True)
    async def role_add_all(self, ctx: core.Context, *, role: core.RoleConverter):
        ...
        for member in members:
            ...
            try:
                await member.add_roles(
                    role,
                    reason=f"Timezones Moderation [{ctx.author}]: Mass role (all)"
                )
                if ctx.guild.members.index(member) != len(ctx.guild.members)-1:
                    await asyncio.sleep(1)
    ...
    @commands.bot_has_permissions(manage_roles=True)
    @commands.has_permissions(administrator=True)
    async def role_add_has(self, ctx: core.Context, has: core.RoleConverter, *, role: core.RoleConverter):
        ...
        for member in members:
            ...
            try:
                await member.add_roles(
                    role,
                    reason=f"Timezones Moderation [{ctx.author}]: Mass role (inrole)"
                )
                if members.index(member) != len(members)-1:
                    await asyncio.sleep(1)
    ...
    @commands.bot_has_permissions(manage_roles=True)
    @commands.has_permissions(administrator=True)
    async def role_remove(self, ctx: core.Context):
    ...
    @commands.bot_has_permissions(manage_roles=True)
    @commands.has_permissions(administrator=True)
    async def role_remove_bots(self, ctx: core.Context, *, role: core.RoleConverter):
    ...
    @commands.bot_has_permissions(manage_roles=True)
    @commands.has_permissions(administrator=True)
    async def role_remove_humans(self, ctx: core.Context, *, role: core.RoleConverter):
        ...
        for member in members:
            ...
            try:
                await member.remove_roles(
                    role,
                    reason=f"Timezones Moderation [{ctx.author}]: Mass role remove (humans)"
                )
                if members.index(member) != len(members)-1:
                    await asyncio.sleep(1)
    ...
    @commands.bot_has_permissions(manage_roles=True)
    @commands.has_permissions(administrator=True)
    async def role_remove_all(self, ctx: core.Context, *, role: core.RoleConverter):
        ...
        for member in members:
            ...
            try:
                await member.remove_roles(
                    role,
                    reason=f"Timezones Moderation [{ctx.author}]: Mass role remove (all)"
                )
                if members.index(member) != len(members)-1:
                    await asyncio.sleep(1)
    ...
    @commands.bot_has_permissions(manage_roles=True)
    @commands.has_permissions(administrator=True)
    async def role_remove_has(self, ctx: core.Context, has: core.RoleConverter, *, role: core.RoleConverter):
        ...
        for member in members:
            ...
            try:
                await member.remove_roles(
                    role,
                    reason=f"Timezones Moderation [{ctx.author}]: Mass role remove (inrole)"
                )
                if members.index(member) != len(members)-1:
                    await asyncio.sleep(1)
    ...
    @commands.has_permissions(administrator=True)
    async def role_cancel(self, ctx: core.Context):
    ...
    @commands.bot_has_permissions(manage_roles=True)
    @commands.has_permissions(manage_roles=True)
    async def role_create(self, ctx: core.Context, color: core.HexConverter, *, name: str) -> None:
        """Create a role"""
    ...
    @commands.bot_has_permissions(manage_roles=True)
    @commands.has_permissions(manage_roles=True)
    async def role_delete(self, ctx: core.Context, *, role: core.RoleConverter) -> None:
        """Delete a role"""

        if role.is_assignable() is False:
            return await ctx.error("I can't manage that role.")

        await role.delete(reason=f"Timezones Moderation [{ctx.author}]")
    ...
    async def role_icon(
        self, 
        ctx: core.Context, 
        source: Union[discord.Emoji, discord.PartialEmoji, core.AttachmentConverter], 
        *, 
        role: core.RoleConverter
    ):
        """Set a role's icon"""
    ...
    @commands.bot_has_permissions(manage_roles=True)
    @commands.has_permissions(manage_roles=True)
    async def role_mentionable(self, ctx: core.Context, *, role: core.RoleConverter) -> None:
    ...
    @commands.bot_has_permissions(manage_roles=True)
    @commands.has_permissions(manage_roles=True)
    async def role_topcolor(self, ctx: core.Context, color: core.HexConverter, *, member: core.MemberConverter = commands.Author) -> None:
    ...
    @commands.bot_has_permissions(manage_roles=True)
    @commands.has_permissions(manage_roles=True)
    async def role_color(self, ctx: core.Context, color: core.HexConverter, *, role: core.RoleConverter) -> None:
    ...
    @commands.bot_has_permissions(manage_roles=True)
    @commands.has_permissions(manage_roles=True)
    async def role_hoist(self, ctx: core.Context, *, role: core.RoleConverter) -> None:
    ...
    @commands.bot_has_permissions(manage_roles=True)
    @commands.has_permissions(manage_roles=True)
    async def role_name(self, ctx: core.Context, role: core.RoleConverter, *, name: str) -> None:
    ...
    @commands.bot_has_permissions(manage_roles=True)
    @commands.has_permissions(manage_roles=True)
    async def role_restore(self, ctx: core.Context, *, member: core.MemberConverter) -> None:
        ...
        await member.add_roles(
            *(role for role in roles if role not in member.roles and role.is_assignable()),
            reason="Timezones Moderation: Restoring member's roles",
            atomic=False
        )
    ...
    @commands.bot_has_permissions(manage_roles=True)
    @commands.has_permissions(manage_roles=True)
    async def role_position(self, ctx: core.Context, position: int, *, role: core.RoleConverter) -> None:
    ...
    @commands.bot_has_permissions(manage_roles=True)
    @commands.has_permissions(manage_roles=True)
    async def role_permissions(self, ctx: core.Context, permissions: int, *, role: core.RoleConverter) -> None:
    ...
    async def purge(
        self, 
        ctx: core.Context, 
        member: Optional[core.MemberConverter],
        amount: int
    ):
    ...
    @commands.bot_has_permissions(manage_messages=True)
    @commands.has_permissions(manage_messages=True)
    async def purge_matches(self, ctx: core.Context, expression: str, amount: int):
    ...
    @commands.bot_has_permissions(manage_messages=True)
    @commands.has_permissions(manage_messages=True)
    async def purge_humans(self, ctx: core.Context, amount: int):
    ...
    @commands.bot_has_permissions(manage_messages=True)
    @commands.has_permissions(manage_messages=True)
    async def purge_bots(self, ctx: core.Context, amount: int):
    ...
    @commands.bot_has_permissions(manage_messages=True)
    @commands.has_permissions(manage_messages=True)
    async def purge_after(self, ctx: core.Context, *, message: core.MessageConverter):
    ...
    @commands.bot_has_permissions(manage_messages=True)
    @commands.has_permissions(manage_messages=True)
    async def purge_stickers(self, ctx: core.Context, amount: int):
    ...
    @commands.bot_has_permissions(manage_messages=True)
    @commands.has_permissions(manage_messages=True)
    async def purge_attachments(self, ctx: core.Context, amount: int):
    ...
    @commands.bot_has_permissions(manage_messages=True)
    @commands.has_permissions(manage_messages=True)
    async def purge_emojis(self, ctx: core.Context, amount: int):
    ...
    @commands.bot_has_permissions(manage_messages=True)
    @commands.has_permissions(manage_messages=True)
    async def purge_mentions(self, ctx: core.Context, amount: int):
    ...
    @commands.bot_has_permissions(manage_messages=True)
    @commands.has_permissions(manage_messages=True)
    async def purge_upto(self, ctx: core.Context, *, message: core.MessageConverter):
    ...
    @commands.bot_has_permissions(manage_messages=True)
    @commands.has_permissions(manage_messages=True)
    async def purge_embeds(self, ctx: core.Context, amount: int):
    ...
    @commands.bot_has_permissions(manage_messages=True)
    @commands.has_permissions(manage_messages=True)
    async def purge_reactions(self, ctx: core.Context, amount: int):
    ...
    @commands.bot_has_permissions(manage_messages=True)
    @commands.has_permissions(manage_messages=True)
    async def purge_links(self, ctx: core.Context, amount: int):
    ...
    @commands.bot_has_permissions(manage_messages=True)
    @commands.has_permissions(manage_messages=True)
    async def purge_webhooks(self, ctx: core.Context, amount: int):
    ...
    async def purge_upto(
        self, 
        ctx: core.Context, 
        start: core.MessageConverter, 
        finish: core.MessageConverter
    ):
    ...
    async def recentjoins(self, ctx: core.Context):
    ...
    @commands.bot_has_permissions(manage_channels=True)
    @commands.has_permissions(manage_channels=True)
    async def nuke(self, ctx: core.Context):
        ...
        conf = await core.confirm(ctx, bot_message)
        ...
        if conf is True:
            ...
            await ctx.channel.delete(reason=f"Timezones Moderation [{ctx.author}]")
    ...
    async def talk(
        ...
        *,
        role: Optional[core.RoleConverter] = None
    ):
    ...
    @commands.bot_has_permissions(manage_channels=True)
    @commands.has_permissions(manage_channels=True)
    async def slowmode(self, ctx: core.Context, timespan: core.Timespan):
        ...
        return await ctx.success(f"Successfully **set** the channel's **message interval** to `{core.fmtseconds(timespan.seconds)}`.")
    ...
    @commands.bot_has_permissions(manage_channels=True)
    @commands.has_permissions(manage_channels=True)
    async def revokefiles(self, ctx: core.Context):
    ...
    @commands.command(
        ...
        example="@mikk.a skidward"
    )
    @commands.bot_has_permissions(manage_nicknames=True)
    @commands.has_permissions(manage_nicknames=True)
    async def rename(self, ctx: core.Context, member: core.MemberConverter, *, nickname: str):
    ...
    async def stickyrole(self, ctx: core.Context):
    ...
    @commands.is_guild_owner()
    async def stickyrole_add(self, ctx: core.Context, *, role: core.RoleConverter):
        """Add a sticky role"""
    ...
    @commands.is_guild_owner()
    async def stickyrole_remove(self, ctx: core.Context, *, role: core.RoleConverter):
    ...
    @commands.is_guild_owner()
    async def stickyrole_list(self, ctx: core.Context):
